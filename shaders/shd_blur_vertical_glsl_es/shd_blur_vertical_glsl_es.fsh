...
vec4 sample_bloom(vec2 uv, vec2 texel)
{
	...
	result += blur_dof(source, texture2D(gm_BaseTexture, uv + vec2(0.0, texel.y)), 0.1945946);
    result += blur_dof(source, texture2D(gm_BaseTexture, uv - vec2(0.0, texel.y)), 0.1945946);
	result += blur_dof(source, texture2D(gm_BaseTexture, uv + vec2(0.0, texel.y * 2.0)), 0.1216216);
    result += blur_dof(source, texture2D(gm_BaseTexture, uv - vec2(0.0, texel.y * 2.0)), 0.1216216);
    result += blur_dof(source, texture2D(gm_BaseTexture, uv + vec2(0.0, texel.y * 3.0)), 0.054054);
    result += blur_dof(source, texture2D(gm_BaseTexture, uv - vec2(0.0, texel.y * 3.0)), 0.054054);	
    result += blur_dof(source, texture2D(gm_BaseTexture, uv + vec2(0.0, texel.y * 4.0)), 0.016216);
    result += blur_dof(source, texture2D(gm_BaseTexture, uv - vec2(0.0, texel.y * 4.0)), 0.016216);
