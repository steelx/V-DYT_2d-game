function KutraDetectPlayerTask(_detect_sprite = sprites_map[$ CHARACTER_STATE.IDLE]) : BTreeLeaf() constructor {
    name = "Kutra Detect Player Task";
	sprite = _detect_sprite;
	ignore_player_in_air = true;
