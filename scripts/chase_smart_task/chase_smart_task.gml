function ChaseSmartTask(_visible_range, _move_speed, _jump_force, _jump_height) : BTreeLeaf() constructor {
    ...
    static Draw = function(_inst_id) {
        ...
        with(_inst_id) {
            ...
            // Draw chase range
            draw_circle_color(x, y, other.visible_range, c_blue, c_blue, true);
