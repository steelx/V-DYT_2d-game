...
*/
function AttackSeqSpawnerTaskOld(_seqeunce_file, _image_alpha_alarm = 2, _attack_delay_seconds = 1.5): BTreeLeaf() constructor {
    ...
    static Process = function() {
        ...
        with(_user) {
			...
			if (other.attack_cooldown <= 0) {
				other.attack_cooldown = other.attack_cooldown_duration;
				...
				disable_self(id);
                //return BTStates.Running;// we will anyway disable the step event
            }
