...
damage = 1;
visible_range = 100;// how far enemy can see
attack_range = 48;
move_speed = 1.2;
...
var _alert_sequence = new BTreeSequence("alert_sequence");
...
_alert_sequence.ChildAdd(new SearchAreaTask(96, 4));
...
_selector_root.ChildAdd(_chase_sequence);
